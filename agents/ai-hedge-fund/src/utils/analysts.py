...
from src.agents.dexter import dexter_agent
...
ANALYST_CONFIG = {
    ...
    "dexter": {
        "display_name": "Dexter",
        "description": "Autonomous Research Analyst",
        "investing_style": "Runs compact, evidence-based research using market data, fundamentals, and news to form a trading signal.",
        "agent_func": dexter_agent,
        "type": "analyst",
        "order": 17,
    },
}
