...
function LayoutContent({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden relative bg-background bento-shell">
      <div className="pointer-events-none absolute inset-0 bento-grid" />
      <div className="pointer-events-none absolute inset-0 bento-blur" />
      ...
      {/* Main content area */}
      <main 
        className="absolute inset-0 overflow-hidden bento-main"
        style={{
