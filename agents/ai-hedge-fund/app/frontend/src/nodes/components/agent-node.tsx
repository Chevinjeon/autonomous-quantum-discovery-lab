...
import { getAgentIcon, getAgentImageUrl } from '@/data/agent-icons';
...
export function AgentNode({
  ...
  return (
    <NodeShell
      ...
      icon={(() => {
        const imageUrl = getAgentImageUrl(id);
        if (imageUrl) return <img src={imageUrl} alt="" className="h-5 w-5 rounded-sm object-contain" />;
